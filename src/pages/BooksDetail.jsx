  ...
  return (
    <div className="p-4 md:p-8 text-white">
          ...
          <table className="w-full mx-auto mt-6 rounded-xl border border-gray-600 text-sm md:text-base">
            <tbody>
              <tr className="border border-gray-600">
                <td className="p-2 md:p-3 bg-gray-800 font-semibold">Género</td>
                <td className=" p-2 md:p-3">{libro.categoria}</td>
              </tr>
              <tr className="border border-gray-600">
                <td className="p-2 md:p-3 bg-gray-600 font-semibold">Año</td>
              ...
              <tr className="border border-gray-600">
                <td className="p-2 md:p-3 bg-gray-600 font-semibold">ISBN</td>
                <td className="bg-gray-600 p-2 md:p-3">{libro.isbn}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap gap-4 mt-4 md:max-w-2xl bg-gray-800 p-4 rounded-lg">
          {libros
